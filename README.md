...
- **개인화된 성공 메시지**: 지원서 수정/삭제 시 지원자 이름 포함 메시지
- **자동 줄바꿈**: 긴 텍스트가 메일과 앱에서 자동으로 줄바꿈
...
- **개인화된 성공 메시지**: 수정/삭제 시 지원자 이름 포함 메시지 표시
- **자동 줄바꿈**: 긴 텍스트가 상세 페이지에서 자동으로 줄바꿈
...
- **자동 줄바꿈**: 긴 텍스트가 화면에 맞춰 자동으로 줄바꿈

### 이메일 알림
- **제출 확인 메일**: 지원서 접수 시 자동 발송
- **수정 안내 메일**: 지원서 수정 시 변경사항 안내
- **결과 안내 메일**: 합격/불합격 결과 발송 (지원동기 제외)
- **HTML 형식**: 깔끔한 HTML 이메일 템플릿
- **한글 지원**: 완전한 한글 이메일 지원
- **자동 줄바꿈**: 긴 텍스트가 30글자마다 자동 줄바꿈
- **단어 중간 끊김 방지**: 자연스러운 줄바꿈 처리
...
- **자동 줄바꿈**: 긴 텍스트의 효율적인 화면 표시
- **개인화된 메시지**: 사용자 친화적인 피드백 시스템

## 최근 업데이트

### v1.3.0 (최신)
- **개인화된 성공 메시지**: 지원서 수정/삭제 시 지원자 이름 포함 메시지 표시
- **자동 줄바꿈 개선**: 긴 텍스트가 메일과 앱에서 자동으로 줄바꿈
- **합/불 메일 간소화**: 결과 메일에서 지원동기 제거로 간소화
- **단어 중간 끊김 방지**: 자연스러운 줄바꿈 처리로 가독성 향상
