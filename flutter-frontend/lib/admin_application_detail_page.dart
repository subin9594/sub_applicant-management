              ...
              child: ListView(
                children: [
                  ...
                  _buildInfoCard('지원 정보', [
                    ...
                    _buildInfoRow('커리큘럼 이수 가능 이유', _application['curriculumReason'] ?? ''),
                    _buildInfoRow('KUHAS에서 얻고 싶은 것', _application['wish'] ?? ''),
                    _buildInfoRow('진로 계획', _application['career'] ?? ''),
                    _buildInfoRow('프로그래밍 언어 경험 여부', _application['languageExp'] ?? ''),
                    ...
                    _buildInfoRow('대면 면접 희망 날짜', _application['interviewDate'] ?? ''),
